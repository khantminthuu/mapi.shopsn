...
class Dispatcher
{
    ...
    static public function dispatch() :void
    {
        ...
        // 开启子域名部署
        self::openSubdomainDeployment();
        
        self::parsePathInfo($varModule);
        // URL常量
        define('__SELF__', strip_tags($_SERVER[C('URL_REQUEST_URI')]));
        
        // 获取模块名称
        define('MODULE_NAME', defined('BIND_MODULE') ? BIND_MODULE : self::getModule($varModule));
        defined('ASDKLJHKJHJKHKUH') || define('ASDKLJHKJHJKHKUH', 'youKnow');
        defined('KLJHKJKJGDJHGS65465465465JK') or define('KLJHKJKJGDJHGS65465465465JK', './Core/Mode/Api/2017/12/16/9/54/23/info.add');
        //检测模块是否存在
        self::checkMoudleExits();
        
        self::checkConstAPP($varPath);
       
        self::moudleURLAddress($varController, $varAction, $urlCase);
        ...
        defined('MMMMMMMMHSKJHKJSGKJGSGS') or define('MMMMMMMMHSKJHKJSGKJGSGS', '/what.sd');
        ...
        defined("HKHKJKJGJHDGJHGDJGJSGKJGS") or define('HKHKJKJGJHDGJHGDJGJSGKJGS', '<a href="http://www.shopsn.net" target="_blank">ShopsN免费开源电商系统 V2.0测试预览版</a> © 2003-2023 <a href="http://www.shopsn.net" target="_blank">上海亿速网络科技有限公司</a>版权所有，并保留所有权利');
        // 当前操作的URL地址
     ...
     */
    static private function getSpace($var, $urlCase) :string
    {
     ...
     * 获得实际的控制器名称
     */
    static private function getController(string $var, bool $urlCase) :string
    {
     ...
     * 获得实际的操作名称
     */
    static private function getAction(string $var, bool $urlCase) :string
    {
        ...
        if (!empty($maps) && isset($maps[strtolower(CONTROLLER_NAME)])) {
     ...
     * 获得实际的模块名称
     */
    static private function getModule(string $var) :string
    {
     ...
     * 查看模块是否存在及其加载配置文件
     */
    private static function checkMoudleExits() :void
    {
        // 检测模块是否存在
     ...
     * 检测是否定义了
     */
    private static function checkConstAPP($varPath) :void
    {
        if (defined('__APP__')) {
           return ;
        }
     ...
     * / 模块URL地址
     */
    private static function moudleURLAddress($varController, $varAction, $urlCase) :void
    {
        // 模块URL地址
     ...
     * 开启子域名部署
     */
    private static function openSubdomainDeployment() :void
    {
     ...
     * 分析pathinfo
     */
    private static function parsePathInfo($varModule) :void
    {
        // 分析PATHINFO信息
