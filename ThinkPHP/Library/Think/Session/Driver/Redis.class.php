...
class Redis implements  \SessionHandlerInterface
{
	...
	public function write($session_id, $session_data)
	{
		if ($this->config['expire'] > 0) {
			return $this->handler->setex($this->config['session_name'] . $session_id, $this->config['expire'], $session_data);
		} else {
			return $this->handler->set($this->config['session_name'] . $session_id, $session_data);
		}
	}
