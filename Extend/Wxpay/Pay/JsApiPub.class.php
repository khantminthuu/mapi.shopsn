...
use Extend\Wxpay\GenialPublicPay\WxPayJsApiPay;
use Extend\Wxpay\WxPayPubHelper;

/**
 * JSAPI支付——H5网页端调起支付接口
 */
class JsApiPub extends WxPayPubHelper
{
	/**
	 *
	...
	public function GetJsApiParameters($UnifiedOrderResult)
	{
		...
		$jsapi->SetNonceStr($this->createNoncestr());
	...
	{
		$urlObj["appid"] = config::$APPID_d;
		$urlObj["secret"] = config::$APPSECRET_d;
		$urlObj["code"] = $code;
